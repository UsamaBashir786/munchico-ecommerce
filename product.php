...
<body>
  ...
  <div class="products-container">
    ...
    <?php include 'includes/productComponents/sidebar-filter/sidebar-filter.php' ?>
    
    <!-- Include Products Grid -->
    <?php include 'includes/productComponents/products-grid/products-grid.php' ?>
  </div>

  <!-- Include JavaScript -->
  <script src="components/sidebar-filter/sidebar-filter.js"></script>
  <script src="components/products-grid/products-grid.js"></script>  
