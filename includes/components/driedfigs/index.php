    ...
    <section class="featured-products" aria-labelledby="featured-products-title">
        <div class="container">
            <h2 id="featured-products-title" class="section-title rc-zoom-in-up">
                <span class="title-line">—</span>
                Dried Figs
                <span class="title-line">—</span>
            </h2>

            <div class="swiper mySwiper rc-zoom-in-up">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="product-slider-card">
                            <div class="product-slider-image">
                                <img src="assets/img/download.webp" alt="Premium Almonds" />
    ...
    <link rel="stylesheet" href="includes/components/driedfigs/css/styles.css">
    <script src="includes/components/driedfigs/js/script.js"></script>