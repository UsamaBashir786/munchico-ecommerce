...
<footer class="modern-footer" aria-label="Website Footer">
  <div class="container">
    ...
    <div class="footer-top">
      ...
      <div class="footer-newsletter">
        ...
        <p class="newsletter-desc">Get exclusive deals, new product launches & health tips!</p>
    ...
    <div class="footer-middle">
      <div class="footer-column">
        ...
        <ul class="footer-links">
          ...
          <li><a href="#">Premium Nuts</a></li>
          <li><a href="#">Seeds & Mixes</a></li>
